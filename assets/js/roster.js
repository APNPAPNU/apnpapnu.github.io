    ...
    $.ajax({
      ...
      error: function(data) {
        ...
        console.log('Error loading player stats:', data);
		  '<div class="j-col j-col-3 member-button"><a class="button outline gold full-width"><a href="https://braytech.org/2/'+ destinyId +'/'+ fstats +'/legend">In Depth Stats</a>' + '</a></div>'
      }
