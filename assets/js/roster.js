...
function listMembers(rsp) {
  ...
  for (var i = 0; i < rsp.length; i++) {
    ...
    if (typeof profile != 'undefined') {
	  ...
	  '<div class="j-col j-col-3 member-button"><a class="button outline gold full-width" href="https://gambit-tracker.firebaseapp.com/#/user/2/'+ destinyId + '">' + 'gambit stats' + '</a></div>'
        );
